  ...
  return (
    ...
    >
      ...
      <dl className="mt-6 space-y-4">
        {
          order.orderProducts.map(product => (
            <div key={product.id} className="flex items-center justify-between">
              ...
              <dd className="text-base font-medium text-gray-900">({product.quantity}) {' '}</dd>
      ...
      <form action={completeOrder}>
        ...
        <input
          type="submit"
          className="bg-indigo-600 hover:bg-indigo-800 text-white w-full mt-5 p-1 uppercase font-bold cursor-pointer"
